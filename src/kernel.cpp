...
unsigned int nForkTimestamp     = 1735689600; // Use v0.3 since 2025-01-01T00:00:00+00:00, TODO: update modifier checkpoints
...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransactionRef& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake)
{
    ...
    if (nTimeBlockFrom + nStakeMinAge > nTimeTx) // Min age requirement
        return false; //return error("CheckStakeKernelHash() : min age violation");
...
bool CheckProofOfStake(const CBlock &block, uint256& hashProofOfStake)
{
    ...
    if (prevTxOut.nValue < nMinimumStakeValue)
    ...
    if (!CheckStakeKernelHash(block.nBits, blockprev, postx.nTxOffset + CBlockHeader::NORMAL_SERIALIZE_SIZE, txPrev, txin.prevout, nTime, hashProofOfStake))
