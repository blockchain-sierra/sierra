# Linearize
Construct a linear, no-fork, best version of the Sierra blockchain. The scripts
...
JSON-RPC server. Running `sierrad` or `sierra-qt -server` will be sufficient.
...
* `input`: sierrad blocks/ directory containing blkNNNNN.dat
