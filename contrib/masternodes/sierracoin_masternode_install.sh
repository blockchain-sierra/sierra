...
#
# If you like the script (visible install, daemon log rotation,
# the final screen, etc), you may donate to:
#   SIERRA: SU8epyMShu1ajR1rBf7CjfQ2W8qgbaJBD8
...
COIN_NAME="Sierra Core"
coin_name="sierra"
COIN_DATA="sierracore"
COIN_PORT=19518
COIN_RPCPORT=19519
...
COIN_TGZ="https://github.com/blockchain-sierra/sierra/releases/download/v3.0.0.0/sierracore-3.0.0-x86_64-linux-gnu.tar.gz"
...
function important_information() {
  ...
  echo -e "${GREEN}================================================================================================================================${NC}"
  echo -e "${COIN_NAME} currently uses DIP3 style masternodes. Please refer to Dash documentation for details."
  echo -e "Useful links can be found at https://github.com/blockchain-sierra/sierra/releases"
  ...
  echo
  echo -e "If you like the script (${GREEN}visible install, daemon log rotation, the final screen${NC}),"
  echo -e "you may donate to:"
  echo -e "  SIERRA: SU8epyMShu1ajR1rBf7CjfQ2W8qgbaJBD8"
