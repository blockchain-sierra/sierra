...
Below are some notes on how to build Sierra Core for Windows.
...
way. This will install to `c:\workspace\sierra`, for example:

    make install DESTDIR=/mnt/c/workspace/sierra
