...
This mechanism has been integrated into Bitcore-Node-Sierra which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sierracoin/insight-api-sierra#web-socket-api](https://github.com/sierracoin/insight-api-sierra#web-socket-api)
* API: [https://github.com/sierracoin/insight-api-sierra#instantsend-transactions](https://github.com/sierracoin/insight-api-sierra#instantsend-transactions)
...
By default, the Sierra Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sierra Core daemon:
