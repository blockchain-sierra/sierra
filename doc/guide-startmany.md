...
### Send 1000 SIERRA to New Addresses

Send exactly 1000 SIERRA to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 SIERRA.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 SIERRA on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the sierra github repo](https://github.com/sierracoin/sierra/blob/master/doc/masternode_conf.md)
...
## Update sierra.conf on server

If you generated a new masternode private key, you will need to update the remote `sierra.conf` files.

Shut down the daemon and then edit the file.

```nano .sierracore/sierra.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `sierra.conf` file.
...
and comparing with the official explorer at https://explorer.sierracoin.org/chain/Sierra
...
Search your Masternodes on https://sierraninja.pl/masternodes.html
